def print_args(args):
    ...
    print("\033[1m" + "Mamba Params" + "\033[0m")
    print(f'  {"N Layer:":<20}{args.n_layer:<20}{"D State:":<20}{args.d_state:<20}')
    print(f'  {"Expand:":<20}{args.expand:<20}{"D conv:":<20}{args.d_conv:<20}')
    print(f'  {"Mamba Conv Bias:":<20}{args.conv_bias:<20}{"Mamba Bias:":<20}{args.bias:<20}')
    # print(f'  {"Period List:":<20}{args.period_list:<20}{"Mamba Bias:":<20}{args.bias:<20}')
    print()
